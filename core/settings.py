...
# Parse ALLOWED_HOSTS from environment, removing whitespace
...
if os.getenv('DATABASE_URL'):
    ...
    # Use SQLite by default (zero-cost, no external database needed)
    DATABASES = {
        'default': {
...
# WhiteNoise compression for efficient static file serving
